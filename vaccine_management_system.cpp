...
void vaccine ::view_vaccine()
{
    ...
    cout<<"\t\t\t\t\t\t Powered By:- IMSC_IT_A_01,IMSC_IT_A_26 "<<endl<<endl;
    cout<<"\n\t\t\t*****************************************\n";
...
void vaccine::search_data()
{
    vaccine item;
      cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 VACCINE MANAGEMENT SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
    cout<<"\t\t\t\t\t\t Powered By:- IMSC_IT_A_01,IMSC_IT_A_26 (LJ UNIVERSITY) "<<endl<<endl;
    cout<<"\n\t\t\t*****************************************\n";
...
int main()
 {
     ...
     int num_vac;
    cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 VACCINE MANAGEMENT SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
    cout<<"\t\t\t\t\t\t Powered By:- IMSC_IT_A_01 , IMSC_IT_A_26"<<endl;
